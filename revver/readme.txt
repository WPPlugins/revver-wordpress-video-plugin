...
2. REQUIRED: Please make sure that the directory is named 'revver'
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Enter your Revver username and password in the 'Revver Configuration' tab under Plugins. *Note: all Revver usernames and playlists will be created under this account, and should not be changed once entered.* 
